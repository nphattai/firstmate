...
family_for_basename() {
  case "$1" in
    ...
    fm-documentation-audiences.test.sh|fm-ensure-agents-md.test.sh|fm-epic-branch.test.sh|fm-epic-lint.test.sh|fm-epic-status.test.sh|fm-grok-harness.test.sh|\
    fm-kimi-harness.test.sh|fm-muse-harness.test.sh|fm-omp-harness.test.sh|fm-herdr-lab.test.sh|fm-lint.test.sh|\
